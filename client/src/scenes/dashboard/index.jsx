    ...
    <Box m="1rem 2rem">
      ...
      >
        ...
        <StatBox
          ...
          value={
            data && data.thisMonthStats ? data.thisMonthStats.totalSales : 0
          }
          increase="+5%"
          description="Since last month"
          icon={
        ...
        <StatBox
          title="Yearly Sales "
          // value={data && data.yearlSales.totalSales}
          value={data && data.yearlySales ? data.yearlySales.totalSales : 0}
          increase="+43%"
          description="Since last month"
          icon={
            <Traffic
